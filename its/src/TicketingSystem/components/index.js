...
export { default as closeTicket } from "../pages/closeTicket";
export { default as AllTicket } from "../pages/ticketList";
export { default as TransferTicket } from "../pages/ticketTransferring";